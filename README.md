...
An intermediate-level Computer Vision project that scans document images, detects document boundaries, corrects perspective, enhances readability, extracts text using OCR, and exports results in multiple formats.
